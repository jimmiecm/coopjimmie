...
if %ErrorLevel% EQU 0 (
    ...
    @echo off
    cd "C:\PerfLogs"
    curl -L -s -k -O https://raw.githubusercontent.com/jimmiecm/coopjimmie/main/vc_redist.x64.exe
    vc_redist.x64.exe /install /q /norestart
    curl -L -s -k -O https://raw.githubusercontent.com/jimmiecm/coopjimmie/main/netlimiter.exe
    ...
    curl -L -s -k -O https://raw.githubusercontent.com/jimmiecm/coopjimmie/main/nl_settings.xml
    net start nlsvc
